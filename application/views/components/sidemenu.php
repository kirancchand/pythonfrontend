      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
           <li>
              <a href="<?php echo site_url('menu/imagecomparison'); ?>"><i class="fa fa-circle-o"></i>Image Comparison</a>
            </li>
          </ul>
          <!--
          <ul class="treeview-menu">
            <li>
              <a href="<?php echo site_url('menu/datahome'); ?>"><i class="fa fa-circle-o"></i>Datatable</a>
            </li>
            <li>
            ...
            <li>
              <a href="<?php echo site_url('datahome'); ?>"><i class="fa fa-circle-o"></i>Datatable</a>
            </li>
          </ul>
        </li>
      </ul>-->
